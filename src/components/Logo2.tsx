...
const Logo2 = forwardRef<any, Props>(({ disabledLink = false, sx }, ref) => {
  const theme = useTheme();

  const PARTNER = 'rgb(110, 103, 96)';

  const DIMA = 'rgb(232, 123, 69)';



  // OR
  // const logo2 = '/logo/logo2_single.svg';
  ...
  const logo2 = (
    <Box ref={ref} sx={{
      ...
      <svg
        ...
        viewBox="85 7 263 85"
      // x="0px" y="0px"
      //style="enable-background:new 0 0 375.17 103.01;"
      //xml:space="preserve"
      >
        {/*<style type="text/css">
          .st0{fill:#69614E;}
  ...
  return <NextLink href="/">{logo2}</NextLink>;
});
